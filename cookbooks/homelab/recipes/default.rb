...
include_recipe 'homelab_proxy::default'
include_recipe 'homer::default'
include_recipe 'mounts::backup-mount'
include_recipe 'mounts::nextcloud-mount'
include_recipe 'mounts::registry-mount'
include_recipe 'mounts::containers-mount'
include_recipe 'mounts::mount-check'
include_recipe 'mounts::check-space-remaining'
